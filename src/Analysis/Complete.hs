    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 28 "CFA.ag" #-}
                   maximum _tlIfinal
                   {-# LINE 358 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 29 "CFA.ag" #-}
                   _hdIinit
                   {-# LINE 363 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 30 "CFA.ag" #-}
                   _tlIfinal
              ...
              _lhsOflow =
                  ({-# LINE 31 "CFA.ag" #-}
                   _hdIflow                                            <>
                   intraEdges _hdIfinal _tlIinit                       <>
                   _tlIflow
                   {-# LINE 375 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 18 "CFA.ag" #-}
                   _hdInodes ++ _tlInodes
                   {-# LINE 380 "Complete.hs" #-}
                   )
              _self =
                  (:) _hdIself _tlIself
              _lhsOself =
         ...
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 45 "CFA.ag" #-}
                   ...
                   {-# LINE 645 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 46 "CFA.ag" #-}
                   _blockIinit
                   {-# LINE 650 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 47 "CFA.ag" #-}
                   _blockIfinal
                   {-# LINE 655 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 48 "CFA.ag" #-}
                   _blockIflow
                   {-# LINE 660 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 18 "CFA.ag" #-}
                   _blockInodes
                   {-# LINE 665 "Complete.hs" #-}
                   )
              _self =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOinit =
                  ({-# LINE 52 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 710 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 53 "CFA.ag" #-}
                   _statIfinal
                   {-# LINE 715 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 54 "CFA.ag" #-}
                   (intraEdge (new _lhsIlabel) _statIinit) <> _statIflow
                   {-# LINE 720 "Complete.hs" #-}
                   )
              _statOlabel =
                  ({-# LINE 55 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 725 "Complete.hs" #-}
                   )
              _self =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 68 "CFA.ag" #-}
                   maximum _bodyIfinal
                   {-# LINE 828 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 69 "CFA.ag" #-}
                   (node (new _lhsIlabel) _self) : _bodyInodes
                   {-# LINE 833 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 70 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 838 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 71 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 843 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 72 "CFA.ag" #-}
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 91 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 940 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 92 "CFA.ag" #-}
                   [node (new _lhsIlabel) _self]
                   {-# LINE 945 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 93 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 950 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 94 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 955 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 960 "Complete.hs" #-}
                   )
              _self =
                  Empty'
              _lhsOself =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOfinal =
                  ({-# LINE 109 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 1076 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 1081 "Complete.hs" #-}
                   )
              _self =
                  Break' ident_
              _lhsOself =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOfinal =
                  ({-# LINE 114 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 1116 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 1121 "Complete.hs" #-}
                   )
              _self =
                  Continue' ident_
              _lhsOself =
