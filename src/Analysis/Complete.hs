    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOinit =
                  ({-# LINE 20 "CFA.ag" #-}
                   _blocksIinit
                   {-# LINE 183 "Complete.hs" #-}
                   )
              _blocksOlabel =
                  ({-# LINE 22 "CFA.ag" #-}
                   _lhsIlabel
                   {-# LINE 188 "Complete.hs" #-}
                   )
    ...
    (\ _lhsIlabel ->
         (let _lhsOflow :: Flow
              ...
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   _statIflow
                   {-# LINE 235 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 18 "CFA.ag" #-}
                   _statInodes
                   {-# LINE 240 "Complete.hs" #-}
                   )
              _self =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 40 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 285 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 41 "CFA.ag" #-}
                   [NodeVarDecl (new _lhsIlabel) _self]
                   {-# LINE 290 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 42 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 295 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 43 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 300 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 305 "Complete.hs" #-}
                   )
              _self =
    ...
    (\ _lhsIlabel ->
         (let _lhsOflow :: Flow
              ...
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   _s1Iflow <> _s2Iflow
                   {-# LINE 364 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 18 "CFA.ag" #-}
                   _s1Inodes ++ _s2Inodes
                   {-# LINE 369 "Complete.hs" #-}
                   )
              _self =
              ...
              _lhsOlabel =
                  ({-# LINE 22 "CFA.ag" #-}
                   _s2Ilabel
                   {-# LINE 388 "Complete.hs" #-}
                   )
              _s1Olabel =
                  ({-# LINE 22 "CFA.ag" #-}
                   _lhsIlabel
                   {-# LINE 393 "Complete.hs" #-}
                   )
              _s2Olabel =
                  ({-# LINE 22 "CFA.ag" #-}
                   _s1Ilabel
                   {-# LINE 398 "Complete.hs" #-}
                   )
    ...
    (\ _lhsIlabel ->
         (let _lhsOflow :: Flow
              ...
              _lhsOfinal =
                  ({-# LINE 21 "CFA.ag" #-}
                   _sIfinal
                   {-# LINE 439 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 20 "CFA.ag" #-}
                   _sIinit
                   {-# LINE 444 "Complete.hs" #-}
                   )
              _lhsOlabel =
                  ({-# LINE 22 "CFA.ag" #-}
                   _sIlabel
                   {-# LINE 449 "Complete.hs" #-}
                   )
              _sOlabel =
                  ({-# LINE 22 "CFA.ag" #-}
                   _lhsIlabel
                   {-# LINE 454 "Complete.hs" #-}
                   )
         ...
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 46 "CFA.ag" #-}
                   ...
                   {-# LINE 664 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 47 "CFA.ag" #-}
                   _blockIinit
                   {-# LINE 669 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 48 "CFA.ag" #-}
                   _blockIfinal
                   {-# LINE 674 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 49 "CFA.ag" #-}
                   _blockIflow
                   {-# LINE 679 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 18 "CFA.ag" #-}
                   _blockInodes
                   {-# LINE 684 "Complete.hs" #-}
                   )
              _self =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOinit =
                  ({-# LINE 53 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 729 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 54 "CFA.ag" #-}
                   _statIfinal
                   {-# LINE 734 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 55 "CFA.ag" #-}
                   (intraEdge (new _lhsIlabel) _statIinit) <> _statIflow
                   {-# LINE 739 "Complete.hs" #-}
                   )
              _statOlabel =
                  ({-# LINE 56 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 744 "Complete.hs" #-}
                   )
              _self =
         ...
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 58 "CFA.ag" #-}
                   ...
                   {-# LINE 782 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 59 "CFA.ag" #-}
                   (node (new _lhsIlabel) _self) : (_stat1Inodes ++ _stat2Inodes)
                   {-# LINE 787 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 60 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 792 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 61 "CFA.ag" #-}
              ...
              _lhsOflow =
                  ({-# LINE 62 "CFA.ag" #-}
                   ...
                   _stat1Iflow                              <>
                   _stat2Iflow
                   {-# LINE 805 "Complete.hs" #-}
                   )
              _stat1Olabel =
                  ({-# LINE 66 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 810 "Complete.hs" #-}
                   )
              _stat2Olabel =
                  ({-# LINE 67 "CFA.ag" #-}
                   maximum _stat1Ifinal
                   {-# LINE 815 "Complete.hs" #-}
                   )
              _self =
         ...
         (let _lhsOlabel :: Label
              ...
              _lhsOnodes =
                  ({-# LINE 79 "CFA.ag" #-}
                   ...
                   {-# LINE 914 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 83 "CFA.ag" #-}
                   new $ newIfJust init_ _lhsIlabel
                   {-# LINE 919 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 84 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 924 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 85 "CFA.ag" #-}
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOinit =
                  ({-# LINE 99 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1009 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 100 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 1014 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 1019 "Complete.hs" #-}
                   )
              _self =
                  ExpStmt' exp_
              _lhsOself =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 102 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1040 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 103 "CFA.ag" #-}
                   [node (new _lhsIlabel) _self]
                   {-# LINE 1045 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 104 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1050 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 105 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 1055 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 1060 "Complete.hs" #-}
                   )
              _self =
                  Assert' exp_ error_
              _lhsOself =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 107 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1080 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 108 "CFA.ag" #-}
                   [node (new _lhsIlabel) _self]
                   {-# LINE 1085 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 109 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1090 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 110 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 1095 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 1100 "Complete.hs" #-}
                   )
              _self =
                  Break' ident_
              _lhsOself =
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 112 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1120 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 113 "CFA.ag" #-}
                   [node (new _lhsIlabel) _self]
                   {-# LINE 1125 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 114 "CFA.ag" #-}
                   new _lhsIlabel
    ...
    (\ _lhsIlabel ->
         (let _lhsOlabel :: Label
              ...
              _lhsOlabel =
                  ({-# LINE 117 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1160 "Complete.hs" #-}
                   )
              _lhsOnodes =
                  ({-# LINE 118 "CFA.ag" #-}
                   [node (new _lhsIlabel) _self]
                   {-# LINE 1165 "Complete.hs" #-}
                   )
              _lhsOinit =
                  ({-# LINE 119 "CFA.ag" #-}
                   new _lhsIlabel
                   {-# LINE 1170 "Complete.hs" #-}
                   )
              _lhsOfinal =
                  ({-# LINE 120 "CFA.ag" #-}
                   [new _lhsIlabel]
                   {-# LINE 1175 "Complete.hs" #-}
                   )
              _lhsOflow =
                  ({-# LINE 19 "CFA.ag" #-}
                   mempty
                   {-# LINE 1180 "Complete.hs" #-}
                   )
              _self =
                  Return' exp_
              _lhsOself =
